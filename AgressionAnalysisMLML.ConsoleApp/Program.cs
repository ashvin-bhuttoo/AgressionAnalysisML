...
namespace AgressionAnalysisMLML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"G:\SentimentAnalysis\Aggression\aggression_merged_v1.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Aggression_score} | Predicted value: {predictionResult.Score}");
